...
namespace WorkingWithStrings
{
    public static class UsingRanges
    {
        ...
        {
            countryCode = serialNumber[(serialNumber.Length - 9) .. (serialNumber.Length - 8)];
            manufacturerCode = serialNumber[(serialNumber.Length - 8) .. (serialNumber.Length - 6)];
            factoryCode = serialNumber[(serialNumber.Length - 5) .. (serialNumber.Length - 1)];
            stationCode = serialNumber[(serialNumber.Length - 1) ..serialNumber.Length];
        }
    }
}
